...
/**
 * @author rahul This class implements Wikipedia markup processing. Wikipedia
 * markup details are presented here:
 * http://en.wikipedia.org/wiki/Help:Wiki_markup It is expected that all methods
 * marked "todo" will be implemented by students. All methods are static as the
 * class is not expected to maintain any state.
 */
